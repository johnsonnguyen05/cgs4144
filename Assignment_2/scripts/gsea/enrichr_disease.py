...
# Step 1: Load your DE results and metadata
...
# Step 3: Perform gene set enrichment analysis using Disease Ontology
...
# Step 4: Combine enrichment results and save to TSV
