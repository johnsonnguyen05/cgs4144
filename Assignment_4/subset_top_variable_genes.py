...
Writes output to expression_data_top5000.tsv in the Assignment 4 directory.
...
def main(argv):
    ...
    p.add_argument("--output", "-o", default="Assignment_4/expression_data_top5000.tsv", help="Output TSV path")
